...
mounted engines, eager-load and boot-cache modes, Puma clustered config,
config-only adapter settings, observability integrations, and direct
native-heavy gem usage such as `ruby-vips` and `nokogiri`.
