...
Storage attachment declaration and action coverage, exact Action Text rich-text
declaration coverage, exact rake task coverage, and mounted Rack app or engine
paths. RSS savings alone are not enough because this transform can move work
